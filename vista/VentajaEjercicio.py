...
class Ui_VentanaEjercicio(object):
    def setupUi(self, VentanaEjercicio):
        ...
        self.textEditDescripcion.setPlaceholderText(
            "Escriba aquí la descripción del ejercicio despues de haberlo detenido"
        ...
        self.textEditDescripcion.setStyleSheet(
            'font: 10pt "MS Shell Dlg 2";\n' "color: rgb(79, 82, 85);"
        )
    ...
    def retranslateUi(self, VentanaEjercicio):
        ...
        self.label_11.setText(
            _translate("VentanaEjercicio", "Descripción del ejercicio")
        )
