...
class VistaCrearUsuario(qtw.QMainWindow):
    ...
    def __init__(self, mode=0):
        ...
        self.inputs = {
            ...
            "Contraseña*": qtw.QLineEdit(echoMode=qtw.QLineEdit.Password),
            "Confirmar contraseña*": qtw.QLineEdit(echoMode=qtw.QLineEdit.Password),
        }
        ...
        for inp in self.inputs.values():
            cx_form.layout().labelForField(inp).setStyleSheet(
